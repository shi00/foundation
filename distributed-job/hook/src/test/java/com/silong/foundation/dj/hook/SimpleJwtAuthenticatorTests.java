...
public class SimpleJwtAuthenticatorTests {
  ...
  private static com.silong.foundation.dj.hook.auth.Result check(Map<String, Claim> m) {
    ...
    return result ? VALID : new Result(false, "Invalid Payloads.");
  }
  ...
  public void test1() {
    ...
    com.silong.foundation.dj.hook.auth.SimpleJwtAuthenticator authenticator =
        com.silong.foundation.dj.hook.auth.SimpleJwtAuthenticator.builder()
  ...
  public void test4() {
    ...
    Result result = authenticatorB.verify(token, m -> VALID);

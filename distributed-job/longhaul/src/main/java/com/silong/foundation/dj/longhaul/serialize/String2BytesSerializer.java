 ...
 */
public class String2BytesSerializer implements BiConverter<String, byte[]> {

  /** 单例 */
  public static final String2BytesSerializer INSTANCE = new String2BytesSerializer();

  /** 构造方法 */
  private String2BytesSerializer() {}

 ...
 */
public class WebClientHttpsOneWayTlsv12Tests extends WebClientHttpsTwoWayTlsv13Tests {

  private static final WebClientSslConfig CLIENT_SSL_CONFIG_ONE_WAY =
      new WebClientSslConfig().trustAll(true).protocols(new String[] {TLSV_1_2});
  ...
  @Test
  @DisplayName("https-TLSv1.2-OneWay-GET")
  void test1() throws IOException {
    getTest();
  }

  @Test
  @DisplayName("https-TLSv1.2-OneWay-DELETE")
  void test2() {
    deleteTest();
  }

  @Test
  @DisplayName("https-TLSv1.2-OneWay-POST")
  void test3() {
    postTest();
  }

  @Test
  @DisplayName("https-TLSv1.2-OneWay-PUT")
  void test4() {
    putTest();
  }

  @Test
  @DisplayName("https-TLSv1.2-OneWay-HEAD")
  void test5() {
    headTest();
  }

  @Test
  @DisplayName("https-TLSv1.2-OneWay-PATCH")
  void test6() {
    patchTest();
  }
}
